...
public class MySqlBedPlaceDAO implements BedPlaceDAO {
	...
	private final static String ADD_BED_PLACE = "INSERT INTO bed-places (tier, image) VALUES (?)";
	private final static String GET_ALL_PLACES = "SELECT * FROM bed-places";
	private final static String GET_PLACE_BY_ID = "SELECT * FROM bed-places WHERE (id = ?)";
	...
	private final static String UPDATE_BED_PLACE = "UPDATE bed_places SET (tier, image) VALUES(?,?) WHERE id=?";
